...
//	public static double  beta=(double)1/num;	
	//领域集集合数量控制
	public static double  nt=num/4;
	//初始萤光素
	public static double  l0=0.005;
	//初始决策半径
	public static double  rd=18;
	//感知半径
	public static double  rs=18;
	//移动步长
	public static double s=0.5;
	//初始目标函数
	public static double  f=5;
	//P1参数
	public static double  P1=0.05;
	//P2参数
	public static double  P2=0.95;
